...
def main():
    ...
    outfile_1 = open("rand_select_1_T1.txt", 'w')
    outfile_0 = open("rand_select_0_T1.txt", 'w')

    oList_1 = [i for i in range(215)]
    oList_0 = [i for i in range(215,321)]
